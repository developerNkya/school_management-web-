                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('deleteById') }}" method="post"
                                                    name="deletable" onsubmit="return confirmDelete(this,'Assignment')">
                                                    @csrf
                                                    <input type="hidden" name="id" value="{{ $assignment->id }}">
                                                    <input type="hidden" name="table" value="assignment">
                                                    <button class="btn btn-danger" type="button"
                                                        onclick="confirmDelete(this,'Assignment')">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="/assignment/save-assignment"
                            ...
                            <div class="form-group" id="subjectGroup">
                                <label for="subjectSelect">Select Assignment Type</label>
                                <select name="assignment_type" class="form-control" id="subjectSelect">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="assignment_file" class="form-control" id="assignment_file"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="dob">Submission Date</label>
                                <input type="date" name="submission_date" class="form-control" id="dob"
                                    required>
                            </div>
